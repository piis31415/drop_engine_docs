...
\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa}{}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa}\index{Installation notes for macOS Catalina (v10.15)@{Installation notes for macOS Catalina (v10.15)}}
\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8280}%
\Hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8280}%
...
\end{DoxyCode}
\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8281}{}\doxysection{\texorpdfstring{node-\/gyp v7}{node-\/gyp v7}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8281}
...
{\bfseries{If you use {\ttfamily npm config set} to change your global {\ttfamily node\+\_\+gyp} you are responsible for keeping it up to date and can\textquotesingle{}t rely on {\ttfamily npm} to give you a newer version when available.}} Use {\ttfamily npm config delete node\+\_\+gyp} to unset this configuration option.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8282}{}\doxysection{\texorpdfstring{Fixing Catalina for older versions of {\ttfamily node-\/gyp}}{Fixing Catalina for older versions of {\ttfamily node-\/gyp}}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8282}
\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8283}{}\doxysubsection{\texorpdfstring{Is my Mac running mac\+OS Catalina?}{Is my Mac running mac\+OS Catalina?}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8283}
...
\end{DoxyCode}
 If {\ttfamily Product\+Version} is less then {\ttfamily 10.\+15} then this document is not for you. Normal install docs for {\ttfamily node-\/gyp} on mac\+OS can be found at \href{https://github.com/nodejs/node-gyp\#on-macos}{\texttt{ https\+://github.\+com/nodejs/node-\/gyp\#on-\/macos}}\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8284}{}\doxysubsection{\texorpdfstring{The acid test}{The acid test}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8284}
To see if {\ttfamily Xcode Command Line Tools} is installed in a way that will work with {\ttfamily node-\/gyp}, run\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{curl\ -\/sL\ https://github.com/nodejs/node-\/gyp/raw/main/macOS\_Catalina\_acid\_test.sh\ |\ bash}
...
If test failed, there is a problem with your Xcode Command Line Tools installation. Continue to Solutions.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8285}{}\doxysubsection{\texorpdfstring{Solutions}{Solutions}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8285}
...
\end{DoxyEnumerate}\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8286}{}\doxysubsection{\texorpdfstring{Installing {\ttfamily node-\/gyp} using the full Xcode}{Installing {\ttfamily node-\/gyp} using the full Xcode}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8286}
...
\end{DoxyEnumerate}\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8287}{}\doxysubsection{\texorpdfstring{Installing {\ttfamily node-\/gyp} using the Xcode Command Line Tools via {\ttfamily xcode-\/select -\/-\/install}}{Installing {\ttfamily node-\/gyp} using the Xcode Command Line Tools via {\ttfamily xcode-\/select -\/-\/install}}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8287}
...
\end{DoxyEnumerate}\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8288}{}\doxysubsection{\texorpdfstring{Installing {\ttfamily node-\/gyp} using the Xcode Command Line Tools via manual download}{Installing {\ttfamily node-\/gyp} using the Xcode Command Line Tools via manual download}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8288}
...
\end{DoxyEnumerate}\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8289}{}\doxysubsection{\texorpdfstring{I did all that and the acid test still does not pass \+:-\/(}{I did all that and the acid test still does not pass \+:-\/(}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b53570709ce461270e4bd07de5fbb4aa_autotoc_md8289}
