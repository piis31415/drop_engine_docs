...
\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc}{}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc}\index{Can I cache this? $<$a href="{}https://travis-\/ci.org/kornelski/http-\/cache-\/semantics"{} $>$$<$img src="{}https://travis-\/ci.org/kornelski/http-\/cache-\/semantics.svg?branch=master"{} alt="{}Build Status"{}/$>$$<$/a$>$@{Can I cache this? $<$a href=""https://travis-\/ci.org/kornelski/http-\/cache-\/semantics"" $>$$<$img src=""https://travis-\/ci.org/kornelski/http-\/cache-\/semantics.svg?branch=master"" alt=""Build Status""/$>$$<$/a$>$}}
\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5823}%
\Hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5823}%


{\ttfamily Cache\+Policy} tells when responses can be reused from a cache, taking into account \href{http://httpwg.org/specs/rfc7234.html}{\texttt{ HTTP RFC 7234}} rules for user agents and shared caches. It also implements \href{https://tools.ietf.org/html/rfc5861}{\texttt{ RFC 5861}}, implementing {\ttfamily stale-\/if-\/error} and {\ttfamily stale-\/while-\/revalidate}. It\textquotesingle{}s aware of many tricky details such as the {\ttfamily Vary} header, proxy revalidation, and authenticated responses.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5824}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5824}
...
The key method is {\ttfamily satisfies\+Without\+Revalidation(new\+Request)}, which checks whether the {\ttfamily new\+Request} is compatible with the original request and whether all caching conditions are met.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5825}{}\doxysubsection{\texorpdfstring{Constructor options}{Constructor options}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5825}
...
If {\ttfamily options.\+ignore\+Cargo\+Cult} is true, common anti-\/cache directives will be completely ignored if the non-\/standard {\ttfamily pre-\/check} and {\ttfamily post-\/check} directives are present. These two useless directives are most commonly found in bad Stack\+Overflow answers and PHP\textquotesingle{}s "{}session limiter"{} defaults.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5826}{}\doxysubsection{\texorpdfstring{{\ttfamily storable()}}{{\ttfamily storable()}}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5826}
Returns {\ttfamily true} if the response can be stored in a cache. If it\textquotesingle{}s {\ttfamily false} then you MUST NOT store either the request or the response.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5827}{}\doxysubsection{\texorpdfstring{{\ttfamily satisfies\+Without\+Revalidation(new\+Request)}}{{\ttfamily satisfies\+Without\+Revalidation(new\+Request)}}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5827}
...
If it returns {\ttfamily false}, then the response may not be matching at all (e.\+g. it\textquotesingle{}s for a different URL or method), or may require to be refreshed first (see {\ttfamily revalidation\+Headers()}).\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5828}{}\doxysubsection{\texorpdfstring{{\ttfamily response\+Headers()}}{{\ttfamily response\+Headers()}}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5828}
...
\end{DoxyCode}
\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5829}{}\doxysubsection{\texorpdfstring{{\ttfamily time\+To\+Live()}}{{\ttfamily time\+To\+Live()}}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5829}
Returns approximate time in {\itshape milliseconds} until the response becomes stale (i.\+e. not fresh).

After that time (when {\ttfamily time\+To\+Live() \texorpdfstring{$<$}{<}= 0}) the response might not be usable without revalidation. However, there are exceptions, e.\+g. a client can explicitly allow stale responses, so always check with {\ttfamily satisfies\+Without\+Revalidation()}. {\ttfamily stale-\/if-\/error} and {\ttfamily stale-\/while-\/revalidate} extend the time to live of the cache, that can still be used if stale.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5830}{}\doxysubsection{\texorpdfstring{{\ttfamily to\+Object()}/{\ttfamily from\+Object(json)}}{{\ttfamily to\+Object()}/{\ttfamily from\+Object(json)}}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5830}
Chances are you\textquotesingle{}ll want to store the {\ttfamily Cache\+Policy} object along with the cached response. {\ttfamily obj = policy.\+to\+Object()} gives a plain JSON-\/serializable object. {\ttfamily policy = Cache\+Policy.\+from\+Object(obj)} creates an instance from it.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5831}{}\doxysubsection{\texorpdfstring{Refreshing stale cache (revalidation)}{Refreshing stale cache (revalidation)}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5831}
When a cached response has expired, it can be made fresh again by making a request to the origin server. The server may respond with status 304 (Not Modified) without sending the response body again, saving bandwidth.

The following methods help perform the update efficiently and correctly.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5832}{}\doxysubsubsection{\texorpdfstring{{\ttfamily revalidation\+Headers(new\+Request)}}{{\ttfamily revalidation\+Headers(new\+Request)}}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5832}
...
\end{DoxyCode}
\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5833}{}\doxysubsubsection{\texorpdfstring{{\ttfamily revalidated\+Policy(revalidation\+Request, revalidation\+Response)}}{{\ttfamily revalidated\+Policy(revalidation\+Request, revalidation\+Response)}}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5833}
...
\end{DoxyCode}
\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5834}{}\doxysection{\texorpdfstring{Yo, FRESH}{Yo, FRESH}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5834}
\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5835}{}\doxysubsection{\texorpdfstring{Used by}{Used by}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5835}
...
\end{DoxyItemize}\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5836}{}\doxysubsection{\texorpdfstring{Implemented}{Implemented}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5836}
...
\end{DoxyItemize}\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5837}{}\doxysubsection{\texorpdfstring{Unimplemented}{Unimplemented}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5837}
...
\end{DoxyItemize}\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5838}{}\doxysubsubsection{\texorpdfstring{Trusting server {\ttfamily Date}}{Trusting server {\ttfamily Date}}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2b9fa4c048037a06b67ce02cca0c366fc_autotoc_md5838}
