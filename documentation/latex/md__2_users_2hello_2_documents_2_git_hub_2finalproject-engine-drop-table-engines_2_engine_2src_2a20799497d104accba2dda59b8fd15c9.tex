...
\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2a20799497d104accba2dda59b8fd15c9}{}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2a20799497d104accba2dda59b8fd15c9}\index{foreground-\/child@{foreground-\/child}}
\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2a20799497d104accba2dda59b8fd15c9_autotoc_md5190}%
\Hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2a20799497d104accba2dda59b8fd15c9_autotoc_md5190}%


Run a child as if it\textquotesingle{}s the foreground process. Give it stdio. Exit when it exits.

Mostly this module is here to support some use cases around wrapping child processes for test coverage and such. But it\textquotesingle{}s also generally useful any time you want one program to execute another as if it\textquotesingle{}s the "{}main"{} process, for example, if a program takes a {\ttfamily -\/-\/cmd} argument to execute in some way.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2a20799497d104accba2dda59b8fd15c9_autotoc_md5191}{}\doxysection{\texorpdfstring{USAGE}{USAGE}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2a20799497d104accba2dda59b8fd15c9_autotoc_md5191}
...
If the callback returns a string value, then that will be used as the signal to exit the parent process. If it returns a number, then that number will be used as the parent exit status code. If it returns boolean {\ttfamily false}, then the parent process will not be terminated. If it returns {\ttfamily undefined}, then it will exit with the same signal/code as the child process.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2a20799497d104accba2dda59b8fd15c9_autotoc_md5192}{}\doxysection{\texorpdfstring{Caveats}{Caveats}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2a20799497d104accba2dda59b8fd15c9_autotoc_md5192}
...
On Windows, issuing a {\ttfamily process.\+kill(process.\+pid, signal)} with a fatal termination signal may cause the process to exit with a {\ttfamily 1} status code rather than reporting the signal properly. This module tries to do the right thing, but on Windows systems, you may see that incorrect result. There is as far as I\textquotesingle{}m aware no workaround for this.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2a20799497d104accba2dda59b8fd15c9_autotoc_md5193}{}\doxysection{\texorpdfstring{util\+: {\ttfamily foreground-\/child/proxy-\/signals}}{util\+: {\ttfamily foreground-\/child/proxy-\/signals}}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2a20799497d104accba2dda59b8fd15c9_autotoc_md5193}
...
It doesn\textquotesingle{}t go in the other direction; ie, signals sent to the child process will not affect the parent. For that, listen to the child {\ttfamily exit} or {\ttfamily close} events, and handle them appropriately.\hypertarget{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2a20799497d104accba2dda59b8fd15c9_autotoc_md5194}{}\doxysection{\texorpdfstring{util\+: {\ttfamily foreground-\/child/watchdog}}{util\+: {\ttfamily foreground-\/child/watchdog}}}\label{md__2_users_2hello_2_documents_2_git_hub_2finalproject-engine-drop-table-engines_2_engine_2src_2a20799497d104accba2dda59b8fd15c9_autotoc_md5194}
